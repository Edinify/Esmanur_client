...
export const IncomesModal = () => {
  ...
  const { incomesModalData, incomesOpenModal } = useSelector(
  ...
  return (
    <div className="create-update-modal-con">
      <div className="create-update-modal">
        ...
        {deleteModal && <DeleteIncomessModal type="incomes" incomesModalData={incomesModalData} deleteMod={handleDeleteModal} />}
      </div>
    </div>
  );
};
