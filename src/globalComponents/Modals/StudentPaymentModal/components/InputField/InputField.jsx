  ...
  const inputData = [
    {
      ...
      marginTop: "0",
      marginBottom: "0",
      inputValue: studentPaymentModalData[inputName] || "",
    },
    {
      inputName: "amount",
    ...
    },
    {
      ...
      marginBottom: "0",
      inputValue:
        studentPaymentModalData[inputName] && inputName === "date"
          ? moment(studentPaymentModalData[inputName]).format("YYYY-MM-DD")
          : "",
    },
  ];
